        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-gray-800">{component.pressure} бар</p>
            </div>
            ...
            <div className="bg-cyan-50 rounded-lg p-4">
              ...
              <p className="text-2xl font-bold text-gray-800">{component.flowRate} л/с</p>
            </div>
          </div>
          ...
          {['prefilter', 'aeration', 'sedimentation', 'carbon', 'disinfection'].includes(component.type) && (
            <button
              onClick={() => onViewDetails(component.id)}
              className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-3 rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all"
            >
