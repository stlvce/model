...
export default function VideoModal({ componentId, onClose }: VideoModalProps) {
  const videoData: Record<string, any> = {
    ...
    carbon: {
      ...
      description: 'Адсорбция органических загрязнителей и улучшение качества воды',
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="mt-4 p-4 bg-blue-50 rounded-lg">
            <h3 className="font-semibold text-gray-800 mb-2">Образовательная информация</h3>
            <p className="text-gray-600 text-sm">
              Это видео демонстрирует реальный процесс очистки воды и помогает понять принципы работы системы.
              Обратите внимание на ключевые этапы и их влияние на качество воды.
            </p>
          </div>
        </div>
      </div>
